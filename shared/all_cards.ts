export = {
  ...
  NOUNS: [
    ...
    [
      "Boxing",
      "An ancient and honorable sport - not just for boys anymore ...",
    ],
    [
      "Boy Scouts",
    ...
    [
      "Canada",
      "Federated country of North America.  The Great White North - eh?",
    ],
    [
      "Canadians",
    ...
    [
      "Celine Dion",
      "1968-, Canadian singer whose heart will go on, and on ...",
    ],
    ...
    [
      "Chickens",
      "From incubator to rotisserie in 56 days!  Run, chicken, run!",
    ],
    [
      "Chimpanzees",
    ...
    [
      "Cindy Crawford",
      "1966- , American Supermodel.  What dreams are made of.",
    ],
    [
      "Clark Gable",
    ...
    [
      "Computer Hackers",
      "We didn't mean to shut down the entire government ...",
    ],
    [
      "Computers",
    ...
    [
      "Italy",
      "European Republic, shaped like a boot - a very fashionable boot.",
    ],
    [
      "Jack Nicholson",
    ...
    [
      "Rappers",
      "PAENTAL ADVISORY EXPLICIT CONTENT Hasn't seemed to hurt sales...",
    ],
    ...
    [
      "Rocket Scientists",
      "Hey!  They're not rocket scie ... oh ... never mind.",
    ],
    [
      "Rocky Mountains",
    ...
    [
      "Sushi",
      "Who would ever have guessed that raw fish could be so fashionable?",
    ],
    ...
    [
      ...
      "How do you like yours - golden brown or flaming?",
    ],
    ...
    [
      "Tree Huggers",
      '"Environmentalists" to the left.  "Wackos" to the right.',
    ],
